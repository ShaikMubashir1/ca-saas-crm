<div>
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Edit Portal Credential</h1>
            <p class="text-sm text-gray-500 mt-1">Modify details for: <span class="font-semibold text-gray-700">{{ $portal_name }}</span></p>
        </div>
    </div>
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input wire:model="password" type="text" id="password" required class="mt-1 block w-full rounded-lg border-0 py-2.5 px-3.5 text-gray-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 transition">
